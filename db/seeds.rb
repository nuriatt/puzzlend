...
Booking.create(user_id:1, puzzle_id:1)
Booking.create(user_id:1, puzzle_id:2)
Booking.create(user_id:2, puzzle_id:3)
Booking.create(user_id:3, puzzle_id:4)
Booking.create(user_id:4, puzzle_id:4)
